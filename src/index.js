...
function generateScripture(event){
    ...
    let emotionInput = document.querySelector("#prompt-input-bar");
    ...
    let hiddenElement = document.querySelector("#scripture");
    hiddenElement.classList.remove("hidden");
    hiddenElement.innerHTML = `<div class="generating"> ⏳ A scripture about being ${emotionInput.value} is generating</div>`;
